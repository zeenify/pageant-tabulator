    ...
    return (
        <MainLayout>
            ...
            <div className="max-w-2xl mx-auto">
                ...
                {/* Back Navigation */}
                <div className="mb-6">
                    <Link href="/judges" className="inline-flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 transition-colors">
                        <ArrowLeft className="w-4 h-4" />
                        <span className="text-sm font-medium">Back to Judges</span>
                    </Link>
                </div>
